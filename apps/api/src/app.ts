...
// Split from server.ts so a test can import the request-handling app
// without also binding a port or standing up Socket.IO — supertest drives
// this directly in memory, same middleware stack as production.
